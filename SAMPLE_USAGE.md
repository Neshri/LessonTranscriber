...
- Ollama running and gemma3:27b-it-qat model pulled (`ollama pull gemma3:27b-it-qat`)
- Dependencies installed
- .env file configured for email functionality (required for sending email summaries)

## 3. Run the Transcriber
### Options:
- `python main.py --monitor` (default: monitors lesson_audio/ for new files, transcribes/summarizes them, and emails summaries)
- `python main.py` (processes all audio files in the configured default directory once)
...
## Note
For full project documentation and setup details, refer to README.md.
